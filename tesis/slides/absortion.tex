...
\scriptsize
    ...
    \begin{itemize}
     \item Absorción: Capacidad del receptor para absorber tecnología de un sector y la asimilación es la capacidad de asimilar y utilizarla en otro sector 
     \item Se deben generar dos tipos de habilidades:
       \begin{itemize}
        \scriptsize
        \item Técnicas: hardware, sistemas operativos.
        \item Humanas: Habilidades y conocimientos.
       \end{itemize}
    ...
    \onslide<11> \node [ph_explain2, right=.5cm of adaptation.east] (exp_adaptation)    
    {
      ...
      \centering
      \includegraphics[scale=.40]{../images/proceso_de_fabricacion_PCBs.pdf}
    };
    ...
    \onslide<12> \node [ph_explain2, right=.5cm of adaptation.east] (exp_adaptation)    
    {
      ...
      \centering
      \includegraphics[scale=.40]{../images/SoC_reverse.pdf}
   };
