    ...
    \onslide<1> \node [difusion_es, right=1cm of absortion.east] (est_difusion)      
      {
       ...
       \includegraphics[scale=.4]{../images/bienes_clasific.png}\\
        ...
        \noindent{Ecuación costo-beneficio de Ostrom:\hfill} \\
        \noindent{$ BC > BN + C $\hfill \\
        BC: Beneficio a contribuir.\hfill \\
        C : Costo de la contribución.\hfill \\
    ...
    \onslide<7> \node [ph_explain2, right=.5cm of absortion.east] (est_difusion)      
      {
       ...
       \begin{center} \includegraphics[scale=.65]{../images/community_members.pdf} \end{center}
      };
