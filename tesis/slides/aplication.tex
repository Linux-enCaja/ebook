...
%     \onslide<3> \node [ph_explain, right=0.5cm of adaptation.east] (exp_aplication)    
%     {
%       \begin{center} \textbf{Aplicación: Estructura del plan de estudios CDIO} \end{center}
%       \centering
%       \includegraphics[scale=.6]{../images/CDIO.pdf}
%       \begin{center} \textbf{Aplicación: Implementación del plan de estudios CDIO} \end{center}
%       \centering
%       \includegraphics[scale=.25]{../images/CDIO_metodologia.pdf}
%     };
...
%       \begin{center} \textbf{Aptitudes personales, profesionales e interpersonales} \end{center}
    ...
    \onslide<8> \node [ph_explain, right=0.1cm of adaptation.east] (exp_aplication)    
    {
...
% &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    \onslide<13> \node [ph_explain, right=0.1cm of adaptation.east] (exp_aplication)    
    {
      \begin{center} \textbf{Aplicación en la Industria: emQbit} \end{center}
      \centering
      \begin{itemize}
        \footnotesize
        \item Ayuda a la creación de la empresa.
        \item Transferencia de conocimientos en técnicas de diseño y fabricación.
          \begin{itemize}
           \footnotesize
           \item Cursos de capacitación.
           \item Estudiantes en modalidad de pasantía.
          \end{itemize}
        \item Trabajo conjunto para desarrollo de plataformas abiertas.
        \item Soporte técnico en el desarollo de aplicaciones.
      \end{itemize}
