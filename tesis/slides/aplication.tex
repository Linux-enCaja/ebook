...
\scriptsize
    ...
    {
      \begin{center} \textbf{Iniciativa CDIO: Habilidades} \end{center}
      \begin{itemize}
      \footnotesize
...
%       \begin{center} \textbf{} \end{center}
      \centering
      \includegraphics[scale=.5]{../images/habilidades_digitales.pdf}
    };
      ...
      \begin{itemize}
        ...
        \item Consolidación de líneas de trabajo inter-disciplinarias.
          \begin{itemize}
            ...
            \item Smart grids.
          \end{itemize}
        \item Aumento del nivel de los proyectos de fin de semestre y de trabajo de grado (Observaciones relizadas en las sustentaciones).
        \item Aumento de investigaciones que utilizan sistemas digitales (Comite asesor de carrera).
        ...
        \item Refuerzo de habilidades: trabajo en equipo, auto-aprendizaje, innovación (encuesta).
      \end{itemize}
    };
...
% 
    \onslide<7> \node [ph_explain2, right=0.1cm of adaptation.east] (exp_aplication)    
    {
      \begin{center} \textbf{Aplicación en Postgrado} \end{center}
      \centering
      \begin{itemize}
       \footnotesize
       ...
       \item Ayuda en la creación de la línea: \textit{Técnicas Digitales}
          ...
          \end{itemize}
       \item Tesis de maestría
          \begin{itemize}
          \footnotesize
            \item Diseño e Implementación de un Sistema  Embebido para la Adquisición y Transmisión de  Señales Biomédicas a Través de la Red  Celular (Comunicaciones).
            \item Diseño y construcción de un Convertidor Electronico Para un Arreglo de LEDs de 70 Vatios de Potencia (Automatización).
            \item Desarrollo de una plataforma flexible para el prototipaje de aplicaciones WSN\footnote{Wireless Network Sensors} (Universidad de Los Andes)
          \end{itemize}
      \end{itemize}
    };
...
%       \begin{center} \textbf{Resultados} \end{center}
%       \centering
%       \includegraphics[width=8cm]{../images/board_monitor_nelson}
%     };
...
% &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    \onslide<8> \node [ph_explain2, right=0.1cm of adaptation.east] (exp_aplication)    
    {
      ...
      \begin{itemize}
       \footnotesize
       \item Microensamble: Empresa prestadora de servicios
            \begin{itemize}
             \footnotesize
