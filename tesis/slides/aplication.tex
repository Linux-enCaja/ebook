...
%       \end{itemize}
    ...
    \onslide<3> \node [ph_explain, right=0.5cm of adaptation.east] (exp_aplication)    
    {
      ...
      \centering
      \includegraphics[scale=.7]{../images/CDIO.pdf}
    };
    ...
    \onslide<4> \node [ph_explain, right=0.5cm of adaptation.east] (exp_aplication)    
    {
      ...
      \centering
      \includegraphics[scale=.27]{../images/CDIO_metodologia.pdf}
    };
    ...
    \onslide<1> \draw[myarrow] (canales_difusion.south) --++(0,-0.2)--++ (-2.3cm, 0) -- (dif_academia.north);   
 y necesidad de un desarrollo sostenible& IE & IE & IE                  \\ \hline
