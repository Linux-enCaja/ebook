...
%       \end{itemize}
    ...
    \onslide<3> \node [ph_explain, right=0.5cm of adaptation.east] (exp_aplication)    
    {
      ...
      \centering
      \includegraphics[scale=.7]{../tesis/images/CDIO.pdf}
    };
    ...
    \onslide<4> \node [ph_explain, right=0.5cm of adaptation.east] (exp_aplication)    
    {
      ...
      \centering
      \includegraphics[scale=.27]{../tesis/images/CDIO_metodologia.pdf}
    };
    ...
    \onslide<6> \node [ph_explain, right=0.5cm of adaptation.east] (exp_aplication)    
    {
      ...
      \centering
      \includegraphics[scale=.45]{../tesis/images/habilidades_digitales.pdf}
    };
