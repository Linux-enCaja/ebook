...
\begin{lstlisting}[numbers=left, style=numbered]
SHELL = /bin/sh
...
En este programa se abre el dispositivo \textit{/dev/fpga} que corresponde a nuestro driver, con las funciones utilizadas para manejo de archivos. y se utiliza la función \textit{read} para leer la información suministrada por el driver.
