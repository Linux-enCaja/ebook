...
El primer paso obvio es obtener la imágen del kernel, la que obtenemos del sitio oficial \textit{ftp.kernel.org}
...
\begin{lstlisting}
arm-none-linux-gnueabi-ld -EL  -p --no-undefined -X  -o vmlinux -T arch/arm/kernel/vmlinux.lds   
...
$ arm-none-linux-gnueabi-objcopy -O binary -R .note -R .comment -S vmlinux linux.bin (3.4MBytes)
