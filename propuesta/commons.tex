...
\begin{figure}[htpb]
  ...
  \caption{Modelo de transferencia tecnológica aplicado a la empresa emQbit} \label{modelo_TT_emqbit}
\end{figure}

La figura \ref{modelo_TT_emqbit} resume el proceso de transferencia tecnológica y de conocimientos desarrollado en este trabajo; una metodología para la adquisición/adaptación/absorción/asimilación/aplicación/difusión del conocimiento asociado a la tecnología 
